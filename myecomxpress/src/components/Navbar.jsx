  ...
  const [menuIcon,setMenuIcon]=useState(false)
    ...
    @media (max-width: ${({ theme }) => theme.media.mobile}) {
      ...
      .navbar-lists {
        ...
        /* transform-origin: top; above css for sening datta to right side */
    ...
    <Nav>
        <div className={menuIcon?"navbar active":"navbar"}>
            <ul className="navbar-lists">
                ...
                <li>
                    <NavLink to="/products" className="navbar-link products-link" onClick={()=>setMenuIcon(false)}>
                       Products
                    </NavLink>
                </li>
                <li>
            ...
            {/* two buttons hamberarg and close for responsive navbar */}
